...
const MainPage = () => {
    return (
        <div className='container mt-3'>
            ...
            <p>В проекте реализованы функции создания, удаления и открытия постов. Также вы можете осуществлять поиск и выбирать различные методы сортировки. Все посты открываются и загружаются комментарии к ним.</p>
            <p>В будущем я планирую добавить функцию бесконечной ленты, возможность открытия профилей пользователей, авторизацию, а также редактирование профилей и другие интересные возможности.</p>
